...
import (
	...
	sendmail "github.com/stlimtat/remiges-smtp/internal/sendmail"
...
func (m *MockIOutput) Write(ctx context.Context, myMail *mail.Mail, responses []sendmail.Response) error {
	m.ctrl.T.Helper()
